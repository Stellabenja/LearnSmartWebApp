                        ...
                        {(isLoggedIn !==1 || this.props.isLoggedIn) &&
                            <ul className="navbar-nav">
                               <li className="nav-item float-right">
                                ...
                                <li className="nav-item float-right">
                                    <Link to="/topics" className="nav-link text-white t-16" id="updloadFileLink">Quiz</Link>
                                </li>
                                <li className="nav-item float-right">
                                    <Link to="/share-data" className="nav-link text-white t-16" id="updloadFileLink">Upload</Link>
                                </li>
                               
                                <li className="nav-item float-right">
                                    <Link to="/status" className="nav-link text-white t-16" id="updloadFileLink">Status 
                                        <span className="mr-5">
                                ...
                                <li className="nav-item float-right">
                                    <Link to="/logout" className="nav-link text-white t-16" id="loginLink">
                                    <span><img className="exit-icon" src={exitIcon} alt=""/></span>
                                    </Link>
